				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom">
						...
						<form role="form" action="" enctype="multipart/form-data" method="POST" name="form" id="myForm">
							<input name="func" type="hidden" value="klient">
							
									<div class="form-group" id="photo">
										<?$sPhoto = selectPhotoKlient();
										$n = 0;?>
										<?foreach ($sPhoto as $item):?>
										<div class="col-md-4 col-sm-6 mix category_1" style="margin-bottom:15px;">
											<div class="mix-inner">
												<img class="img-responsive" src="http://<?=$_SERVER['SERVER_NAME']?>/phpScripts/phpThumb/phpThumb.php?src=/images/klient/<?=$item["img"]?>&w=150&h=95&far=1&bg=ffffff">
