<script>
  function uploadProductTyres(page, total) {
    ...
    $.ajax({
      type: "POST",
      url: "/adminius/inc/uploadProduct/tyresFortochki.inc.php",
      dataType: "html",
      data: "page=" + page,
  ...
  function uploadProductDisk(page, total) {
    ...
    $.ajax({
      type: "POST",
      url: "/adminius/inc/uploadProduct/diskFortochki.inc.php",
      dataType: "html",
      data: "page=" + page,
      success: function (msg) {
        if (+total >= +msg) {
  ...
  function uploadProduct() {
    ...
    $.ajax({
      type: "POST",
      url: "/adminius/inc/uploadProduct/countTyresFortochki.inc.php",
      dataType: "html",
      success: function (msg) {
        if (msg) {
          msg = +msg - 1;
          $("#progressbar").show();
          uploadProductTyres(0, msg);
        }
      }
    });
  }
  ...
  function countPageDisk() {
    $.ajax({
      type: "POST",
      url: "/adminius/inc/uploadProduct/countDiskFortochki.inc.php",
      dataType: "html",
      success: function (msg) {
        msg = +msg - 1;
        uploadProductDisk(0, msg);
      }
    });
  }
</script>
      ...
      <div id="progressbar" style="display:none;">
        ...
        <div class="progress">
          <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0"
               aria-valuemax="100" style="width: 0%" id="progressBarTyres">
                                            <span class="sr-only">
                                            </span>
          </div>
        </div>
        ...
        <div class="progress">
          <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0"
               aria-valuemax="100" style="width: 0%" id="progressBarDisk">
                                            <span class="sr-only">
                                            </span>
          </div>
        </div>
