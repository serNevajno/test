<script>
    ...
    function uploadProductDisk(page, total){
        ...
        $.ajax({
            type: "POST",
            url: "/adminius/inc/uploadProduct/upProvider9Disk.inc.php",
            dataType: "html",
            data: "count="+page,
            success: function (msg) {
                if(+total>=+msg){
    ...
    function countPageDisk(){
        $.ajax({
            type: "POST",
            url: "/adminius/inc/uploadProduct/countProvider9Disk.inc.php",
            dataType: "html",
            success: function (msg) {
    ...
    function delBufer(){
        $.ajax({
            type: "POST",
            url: "/adminius/inc/uploadProduct/deleteBuferSHS.inc.php",
            dataType: "html"
        });
    }
</script>
