        ...
        <div class="tab-content">
          <div class="tab-pane active fontawesome-demo" id="tab_0">
            <div class="portlet-body">
              <h2 class="margin-bottom-20">Номер заказа: <?= $item["order_phone"] ?><?= $_GET["id"] ?></h2>
              ...
              <div class="row">
                <div class="col-md-6">
                    ...
                    <label class="control-label col-md-3">
                      <b>
                        <? switch ($item['typeUser']) {
                          case 1;
                            $typeUser = 'Имя фамилия:';
                            break;
                          case 2;
                            $typeUser = 'Название ИП:';
                            break;
                          case 3;
                            $typeUser = 'Название юр.лица:';
                            break;
                          default:
                            $typeUser = 'Имя фамилия:';
                            break;
                  ...
                  <? if ($item["name_сontact"]) { ?>
                    <div class="row col-md-12 form-group">
                      <label class="control-label col-md-3"><b>Имя контакта: </b></label>
                      <div class="col-md-9"><?= $item["name_сontact"]; ?></div>
                    </div>
                  <? } ?>
                </div>
                <!--/span-->
                <div class="col-md-6">
                  <?if($item['jur_address']){?>
                    <div class="row col-md-12 form-group">
                      <label class="control-label col-md-3"><b>Юр.адрес:</b></label>
                      <div class="col-md-9"><?=$item['jur_address']?></div>
                    </div>
                  <?}?>
                  <div class="row col-md-12 form-group">
                    <?if($item['INN']){?>
                      <div class="row col-md-6 form-group">
                        <label class="control-label col-md-3"><b>ИНН:</b></label>
                        <div class="col-md-9"><?=$item['INN']?></div>
                      </div>
                    <?}?>
                    <?if($item['KPP']){?>
                      <div class="row col-md-6 form-group">
                        <label class="control-label col-md-3"><b>КПП:</b></label>
                        <div class="col-md-9"><?=$item['KPP']?></div>
                      </div>
                    <?}?>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="row col-md-12 form-group">
                    ...
                    <div class="col-md-9"><?if($item['pay_name']){echo $item['pay_name'];}else{echo 'не выбрано';}?></div>
                  </div>
                  <div class="row col-md-12 form-group">
                    <a class="btn btn yellow btn-removable" style="margin-bottom: 5px;" data-toggle="modal" data-target="#addShipment">Отправить заказ клиенту</a>
                    <?if(checkLogShipment($_GET["id"], '0')>0){?>
                        <a class="btn blue" style="margin-bottom: 5px;" href="/adminius/templates/printMarking2.tpl.php?id=<?=$_GET["id"]?>&internal=0">
                            <i class="fa fa-print"></i> Распечатать маркировку
                        </a>
                    <?}?>
                    <a class="btn btn yellow btn-removable" style="margin-bottom: 5px;" data-toggle="modal" data-target="#addShipmentInternal">Переместить товар</a>
                    <?if(checkLogShipment($_GET["id"], '1')>0){?>
                       <a class="btn blue" style="margin-bottom: 5px;" href="/adminius/templates/printMarking2.tpl.php?id=<?=$_GET["id"]?>&internal=1">
                          <i class="fa fa-print"></i> Распечатать маркировку
                       </a>
                    <?}?>
                  </div>
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                          ...
                          <? foreach (sLast2OrderByPhoneOrName($item["phone"], $item["name"], $_GET['id']) as $lastOrder) { ?>
                            <tr>
                              <td><a
                                    href="/adminius/index.php?code=orders&action=edit&id=<?= $lastOrder['id'] ?>"><?= $lastOrder['id'] ?> </a>
                              </td>
                              <td>
                      ...
                      <div class="form-group">
                        <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012"
                          ...
                          <input type="text" class="form-control" readonly="" name="from"
                                 value="<? if ($item["pdzz"] != "2017-00-00 00:00:00" AND $item["pdzz"] != "0000-00-00 00:00:00") {
                                   echo date("Y-m-d", strtotime($item["pdzz"]));
                                 } ?>" placeholder="Введите дату" id="pdzz"
                                 onchange="uploadPDZZ('<?= $_GET["id"] ?>');">
              ...
              <div class="row">
                    ...
                    <div class="col-md-9">
                      ...
                      <form action="index.php" method="POST" name="refform">
                        ...
                        <input type="text" name="expectation" class="form-control input-small" id="expectation"
                               style="float: left; height: 25px; padding: 0; width: 50px !important; padding-left: 10px; margin-left: 10px;<? if ($item['id_status'] != "11") echo "display:none;"; ?>"
                               placeholder="Время ожидания" value="<?= $item['expectation_hours'] ?>"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-static">
                        <?= selectClearSummOrderById($_GET["id"]) ?> руб
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <? if ($item['prepayment'] > 0) {
                      ...
                      <label class="control-label col-md-12"><b>Дата предоплаты
                                                                - <?= $item['prepayment_date']; ?></b></label>
                    <? } ?>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="checkbox-list">
                      <input type="checkbox" value="1" data-id="<?= $_GET['id'] ?>" id="beznal"
                             name="beznal" <? if ($item["beznal"] == 1) echo "checked"; ?> onclick="checkBeznal()">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-md-3"><b>УПД подписан</b>:</b></label>
                    <div class="checkbox-list">
                      <input type="checkbox" value="1" data-id="<?= $_GET['id'] ?>" data-title="upd" id="upd"
                             name="upd" <? if ($item["upd"] == 1) echo "checked"; ?>
                             onclick="javascript:if(confirm('Вы уверены что хотите подписать УПД?')){checkUpd()}">
                    </div>
                  </div>
                </div>
              </div>
              <div class="row">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3"><b>Коментарий менеджера:</b><br>
                      <? if ($item['date_comm'] != '0000-00-00 00:00:00') { ?>
                        <span
                            style="font-size:10px;">Дата комментария: <?= date("d-m-Y H:i:s", strtotime($item['date_comm'])) ?></span>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-static"><?= $item['comment']; ?></p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <? if ($item['id_status'] != "3") { ?>
                ...
                <? /*if($_SERVER['REMOTE_ADDR'] == '212.2.135.222'){}*/ ?>
              ...
              <table class="table table-striped table-bordered table-hover" id="sample_1">
                ...
                foreach ($select_order as $item_order):
                  ...
                  <tr class="odd">
                    ...
                    <td class=""><?=$sWeigth["weight_1"]*$item_order["quantity"]?> / <?=$sWeigth["scope_1"]*$item_order["quantity"]?></td>
                    ...
                    <td class="">
                      <? if ($item_order["nzsp"]) {
                        ...
                        <? if ($item_order["id_provider"] == "1") {
                          ?>
                          <br><a onclick="chechStatusFortochki('<?= $item_order["nzsp"] ?>');" style="cursor:pointer;">Проверить
                                                                                                                       статус</a>
                        <? } ?>
                        <? if ($item_order["id_provider"] == "2") {
                          ?>
                          <br><a onclick="checkStatusKD('<?= $item_order["nzsp"] ?>');" style="cursor:pointer;">Проверить
                                                                                                                статус</a>
                        <? } ?>
                      <? } else {
                        ?>
                        <? if ($item_order["id_provider"] == "1") {
                          ?>
                          <form action="index.php" method="POST" name="orderFortocki<?= $item_order['id'] ?>"
                                style="display:none;">
                          ...
                          <a class="btn btn-xs yellow btn-removable" data-id="1"
                             href="javascript:if(confirm('Вы уверены?')){orderFortocki<?= $item_order['id'] ?>.submit();}">Отправить
                                                                                                                           заказ</a>
                        ...
                        <? if ($item_order["id_provider"] == "2") {
                          ?>
                          <button class="btn btn-xs yellow" data-toggle="modal" data-target="#addOrder" id="btn-modal"
                                  onclick="addOrderKolesaDarom(<?= $item_order['id'] ?>)">Создать заказ
                          </button>
                       ...
                       <!-- <form action="index.php" method="POST" name="inStorage<?/*= $item_order['id'] */?>"
                        ...
                        <a class="btn btn-xs yellow btn-removable" data-id="1"
                          ...
                          <a class="btn btn-xs yellow btn-removable" data-toggle="modal" data-target="#modalStorage"
                             onClick="changeStorage('<?= $item_order['id']?>', '<?=$item["region_id"]?>')">Оприходовать товар</a>
                      <? } ?>
                    </td>
                    <td class="">
                      <a class="btn btn-xs blue btn-editable" data-id="1"
              ...
              <hr>
              Общий вес: <span id="weight"><?=$weight?></span> кг, общий объем: <span id="scope"><?=$scope?></span> м3 <br>
              ...
              <div class="row">
                <div class="form-group">
                  <a href="<?= $_COOKIE["back_url"]; ?>" class="btn blue" style="float:right;margin-right: 25px;">Назад</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <? if (selectPriceProviderAll($rProd['product_id'])) { ?>
                <div class="col-md-12" style="margin-top: 10px;">
                  <table class="table table-bordered table-striped table-condensed flip-content">
                      ...
                      <tr <?= $style ?> id="trProvider<?=$priceProd['id_provider']?>">
                        <td>
                          <label class="radio-inline">
                            <input type="radio" onclick="changePosOrder(<?= $rProd['id'] ?>, <?= $priceProd['price'] ?>, <?= $priceProd['price_clear'] ?>, <?= $priceProd['logistic'] ?>, <?= $priceProd['id_provider'] ?>, <?= $rProd['product_id'] ?>, <?= $rProd['region'] ?>)" name="provider[<?= $rProd['id'] ?>]" value="<?= $priceProd['id_provider'] ?>"
                              <? if ($priceProd['id_provider'] == $rProd['provider']) {
                                echo "checked";
                              } ?>> <?= $priceProd['name'] ?>
                          </label>
                    ...
                    <? } ?>
                    <?if ($rProd['provider'] == 12) {$style = "style='color: #cb1010; font-weight: 600;'";}else{ $style = "";}?>
                    <tr <?=$style?> id="trProvider12">
                      <?$sPriceProvider12 = sPriceProvider12($rProd['id']);?>
                      <td>
                      </td>
                      <td>
                          <input type="text" name="price" id="price" value="<?=$rProd['price']?>" placeholder="Введите цену" class="form-control">
                      </td>
                      <td>
                        <input type="text" name="price_clear" id="price_clear" value="<?=$rProd['price_clear']?>" placeholder="Введите чистую цену" class="form-control">
                      </td>
                      <td></td>
                      <td>
                        <input type="text" name="logistic" id="logistic" value="<?=$rProd['day']?>" placeholder="Введите дни доставки" class="form-control">
                      </td>
                      <td><a class="btn blue btn-sm" onclick="changeOtherProvider(<?= $rProd['id'] ?>)" style="cursor: pointer;">сохранить</a></td>
                    </tr>
                    </tbody>
                  </table>
                </div>
      ...
      <div class="row">
        <form role="form" method="POST">
          ...
          <div class="col-md-12" style="margin-bottom: 65px">
            ...
            <input type="text" placeholder="Начните писать код товара или название" class="form-control" name="code"
            ...
            <? foreach ($select_order as $item) { ?>
              <tr class="odd">
                ...
                <td class=""><? if ($item["id_user"] > 0 AND $item["order_phone"] != "T") {
                    ?><a
                    href="/adminius/index.php?code=users&action=detail&id=<?= $item["id_user"] ?>"><?= $item["name_user"] ?></a><? } else {
