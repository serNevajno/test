<div class="modal fade" id="addShipmentInternal" tabindex="-1" role="dialog" aria-hidden="true" style="top:20px;left:unset; width: 60%; margin-left:unset;">
                    ...
                    <div class="col-md-12">
                        <div class="tabbable tabbable-custom">
                            ...
                            <form role="form" action="" enctype="multipart/form-data" method="POST" name="form" id="myForm">
                                ...
                                <input name="internal" type="hidden" value="1">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="sender" class="form-control input-medium" required>
                                            ...
                                            <?foreach (selectRegion() as $iSender){?>
                                                <option value="<?=$iSender["id"]?>"><?=$iSender["region"]?></option>
                                            <?}?>
                                        </select>
                                    </div>
                                    <?/*<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="recipient" class="form-control input-medium" required>
                                            <option>Выбрать</option>
                                            <?foreach (selectRegion() as $iSender){?>
                                                <option value="<?=$iSender["id"]?>"><?=$iSender["region"]?></option>
                                            <?}?>
                                    ...
                                    <div class="form-group">
                                            <label>Товар: <font color="red">*</font></label>
                                            <select name="product[]" class="form-control" required multiple>
                                                <?foreach (selectOrderProductById($_GET["id"]) as $iProduct){?>
                                                    <?if($iProduct["in_storage"] != $item["region_id"]){?>
