				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom">
						...
						<form role="form" action="" enctype="multipart/form-data" method="POST" name="form" id="myForm">
							<input name="func" type="hidden" value="stock">
							...
							<div class="form-actions">
								...
								<button type="button" class="btn red" onClick='location.href="/adminius/index.php?code=stock"'>Отмена</button>
							</div>
						</form>
					</div>
				</div>
		...
		<div class="portlet box purple">
			...
			<div class="portlet-body">
				<div class="table-toolbar">
					<div class="btn-group">
						<button id="sample_editable_1_new" class="btn green" onClick='location.href="/adminius/index.php?code=stock&action=add"'>
						...
						<div class="dataTables_filter" id="sample_1_filter">
							<div class="col-md-6">
								<div class="input-group input-medium">
									<form action="/adminius/index.php" method="GET" style=" display: inline-table;"><input name="code" type="hidden" value="stock"/>
				...
				<?$select_blog = selectAllBlog($page, $num, "2", $search);
					...
					<div class="table-scrollable">
						...
						<?$n=1+$start;
							foreach ($select_blog as $item){
								...
								<tr>
									<td><?=$n?></td>
									<td><a href="/adminius/index.php?code=stock&action=edit&id=<?=$item["id"]?>"><?=$item['name']?></a></td>
									<td><span class="label label-sm label-<?=$class?>"><?=$act?><?$item["active"]?></span></td>
									<td><?=$item['date']?></td>
									<td>
										<a class="btn btn-xs blue btn-editable" data-id="1" href="/adminius/index.php?code=stock&action=edit&id=<?=$item["id"]?>"><i class="fa fa-pencil"></i> Edit</a> 
										<?if($access["del"] == 1){?>
