        ...
        $('#sex').editable({
            ...
            display: function (value, sourceData) {
				...
				$('#delivery').editable({
						...
						pk: 1,
						name: 'delivery',
            prepend: "Выберите тип доставки",
            inputclass: 'form-control',
            source: [{
                  value: 1, text: 'Самовывоз'
                }, {
                  value: 2, text: 'Доставка силами нашего магазина'
                }, {
						      value: 3, text: 'Доставка транспортной компанией'
                }
            ],
        });
        $('#region_id_add').editable({
            url: '/adminius/inc/editorder.inc.php',
            pk: 1,
            name: 'region_id_add',
            prepend: "Выберите регион",
            inputclass: 'form-control',
            source: [{
                value: 1, text: 'Челябинск'
            }, {
                value: 2, text: 'Уфа'
            }, {
                value: 3, text: 'Екатеринбург'
            }
            ],
        });
        $('#status').editable();
