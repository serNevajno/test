...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $result = db2array("SELECT t1.id, t1.date, t1.date_end, t1.id_user, t1.summ, t2.code, t2.name as name_status, t3.name as name_user, t1.order_phone, t1.name as name_order, t1.comments, t1.prepayment, t1.prepayment_date, t1.beznal, t0.name as name_product, t0.quantity, t0.price, t0.price_clear FROM order_product as t0
            LEFT JOIN orders as t1 on(t0.id_order=t1.id)
			LEFT JOIN status as t2 on(t1.id_status = t2.id) 
			LEFT JOIN users as t3 on(t1.id_user = t3.id) WHERE t1.id_status='1' AND t1.date_end>='$_POST[from] 00:00:00' AND t1.date_end<='$_POST[to] 23:59:59'$man_query ORDER BY t1.date DESC", 2);
