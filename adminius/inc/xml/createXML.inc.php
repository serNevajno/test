<?include ($_SERVER['DOCUMENT_ROOT'].'/inc/db.inc.php');
	...
	$fp = fopen($_SERVER['DOCUMENT_ROOT']."/price/price.xml", "w");
...
$temp = db2array("SELECT COUNT(DISTINCT t4.id) FROM categories as t1 
...
$total = (($temp["COUNT(DISTINCT t4.id)"] - 1) / 200) + 1;
$total =  intval($total);
