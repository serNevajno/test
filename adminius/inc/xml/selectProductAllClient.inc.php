...
if($posts>0){
    ...
    $arProd = db2array("SELECT id, img, name, price, categories, article FROM product WHERE active='1' AND categories IN ($_POST[categories]) AND categories!='1' AND categories!='2' ORDER BY priority DESC, date DESC LIMIT $start, $num", 2);
    $xml ="";
