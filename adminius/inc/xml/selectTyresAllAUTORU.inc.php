<?
    ...
    $result = db2array("SELECT t4.name, t3.name as model, t2.name as marka, t6.value as diameter, t4.price, t4.article, t4.id, t4.code, t3.img, t4.availability FROM categories as t1 LEFT JOIN categories as t2 on(t1.id=t2.section) LEFT JOIN categories as t3 on(t2.id=t3.section) LEFT JOIN product as t4 on(t3.id=t4.categories) LEFT JOIN filter_value as t5 on(t4.id=t5.id_product) LEFT JOIN element_filter as t6 on(t5.element_value=t6.id) WHERE t1.id='1' AND t4.active='1' AND t4.availability>0 AND t5.id_filter='20' ORDER BY t1.id ASC LIMIT $start, $num", 2);
