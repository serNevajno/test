                            ...
                            <div class="col-sm-8 col-md-9">
                                <div class="blog blog-grid blog-lg">
                                    ...
                                    <div class="blog-item  no-bg p-lg-0">
                                        <?if($meta_item["img"]){?>
                                            <img class="img-responsive" src="http://<?=$_SERVER['SERVER_NAME']?>/scripts/phpThumb/phpThumb.php?src=/images/news/<?=$meta_item["img"]?>&w=710&h=328&far=1&bg=ffffff&f=jpg" alt="<?=$meta_item["title"]?>">
                                        <?}?>
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-md-9">
                                <div class="blog blog-list blog-lg" id="sNews">
                                    ...
                                    <?foreach(selectBlog(2, $page) as $iNews){?>
                                        <div class="blog-item">
                                            <div class="row">
                                                <div class="col-sm-5 col-md-5">
                                                    <a href="/news/<?=$iNews["code"]?>-<?=$iNews["id"]?>.html" class="hover-img"><img src="http://<?=$_SERVER['SERVER_NAME']?>/scripts/phpThumb/phpThumb.php?src=/images/news/<?=$iNews["img"]?>&w=304&h=201&far=1&bg=ffffff&f=jpg" alt="image"></a>
                                                </div>
