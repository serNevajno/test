			...
			dataFilter.addRules(
				{
					elements :
					{
						div : function( element )
						{
							...
							{
								var fakeImg = editor.createFakeParserElement( element, 'cke_pagebreak', 'div', '#page_break#' );
...
CKEDITOR.plugins.pagebreakCmd =
{
	exec : function( editor )
	{
		...
		var label = editor.lang.pagebreakAlt;
		var breakObject = CKEDITOR.dom.element.createFromHtml( '<div style="page-break-after: always;">#page_break#' );

		// Creates the fake image used for this element.
		breakObject = editor.createFakeElement( breakObject, 'cke_pagebreak', 'div', '#page_break#' );
